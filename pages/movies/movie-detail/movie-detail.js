...
Page({
    ...
    onLoad: function(options) {
        ...
        console.log('this movie-detail movieId is ', movieId);
        ...
        // //(movie)为接收Movie.js里的movie数据，此处的function不是在这个Page里被调用的，如果写成this.setData，会报错this.setData is not a function，因为找不到this的指代是谁
        ...
        movie.getMovieData((movie) => {
            ...
            console.log('Object movie is ', movie)
        });
